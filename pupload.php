            ...
            else 
                {
                    ...
                    $nome_final = $_SESSION['cpf']."-".date('ymd-his').'.docx';
                        ...
                        if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'] . $nome_final)) {
                            ...
                            $procuraID = $conn->query("SELECT * FROM participante WHERE `cpf` LIKE '$cpf'");
                            ...
                            $mail->Body    = utf8_decode(''.$autor.' enviou o trabalho '.$titulo.' para visualizar <a href="http://www.ifmtsvc.edu.br/jornadacientifica/jornada2018/materialEnviado/'.$nome_final.'" >clique aqui</a>');
